#!/bin/ksh
# This script was generated Tue Jun  4 19:29:28 2024 by:
#
...
#	/home/buet/cds_work/test/chase/run2.xcn -assura_run_dir \
#	/home/buet/cds_work/test/chase -assura_run_name run2 -rcxdir \
#	/home/buet/cds_work/test/chase/run2 -xy_coordinates c,r -type full \
...
#	/home/buet/cds_work/test/chase/run2/extview.tmp -net_name_space \
...
##AGDS_TEXT_LAYERS=
##ARRAY_VIAS_SPACING=
##ASSURA_RUN_DIR=/home/buet/cds_work/test/chase
...
##NETS_FILE=/dev/null
##OUTPUT=/home/buet/cds_work/test/chase/run2/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/buet/cds_work/test/chase/run2
##RCXFS_HIGH=N
...
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
cd /home/buet/cds_work/test/chase/run2
...
/home/buet/cds_work/test/chase/run2.xcn
ENDCAT
...
vdbToRcx /home/buet/cds_work/test/chase run2 -unit meters -- -V1 -H satfile \
	-r /home/buet/cds_work/test/chase/run2.xcn -df2 -xgl
...
advgen -V -g0 -li -f -n -o HSPICE -h ${HIERARCHY_DELIMITER} -TL L1T0 -cgnd \
	...
	/home/buet/cds_work/test/chase/run2/extview.tmp
